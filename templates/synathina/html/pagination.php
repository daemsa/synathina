...
function pagination_list_render($list)
{
	...
	$html = '<div class="module module--center">
						<ul class="pagination">';
...
function pagination_item_active(&$item)
{
	...
	return '<li class="'.$class1.'"><a title="' . $item->text . '" href="' . $item->link . '" class="pagenav">' . $display . '</a></li>';
}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="prev"><a><i class="fa fa-angle-left"></i></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="next"><a><i class="fa fa-angle-right"></i></a></li>';
	}
