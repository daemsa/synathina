...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        var $body = $('body');
        var $barPos = $body.find('.main-bar .main-bar-inner');
        var FP = $.fn.fullpage;
        ...
        */
        function styleSection(section, index){
            ...
            // init firts section - nav color
            if (typeof options.navSectionColor[index] !== 'undefined') {
                $barPos.attr('data-navcolor', options.navSectionColor[0]);
            }
        }
        ...
        */
        ...
        /** 
         * Sets a global color to the side bar in conjuction the activated section 
         */
        function colorMenu(anchor, index) {
            console.log(anchor);
            console.log(index);
        }
        /**
        ...
        */
        function addVerticalNavigation(){
            ...
            $barPos.append('<div id="' + SECTION_NAV + '"><ul></ul></div>');
        ...
        */
        ...
        function activateMenuAndNav(anchor, index){
            ...
            if (typeof options.navSectionColor[index] !== 'undefined') {
                $barPos.attr('data-navcolor', options.navSectionColor[index]);
            }            
        }
