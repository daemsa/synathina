var Areas = (function(global){
  ...
  function initPolygons(areaObj, styles) {
     AjaxCall.kmlToJson( function(jsonData) { createPaths(map, jsonData, styles, areaObj.details) }, areaObj.kmlPath );
  }
  ...
  var a_area, b_area, f_area, g_area, polygonsArray = [], cachedStyles = [];
