CREATE TABLE IF NOT EXISTS `#__requests_books` (
...
CREATE TABLE IF NOT EXISTS `#__requests_libraries` (
...
CREATE TABLE IF NOT EXISTS `#__requests_waitlists` (
...
CREATE TABLE IF NOT EXISTS `#__requests_wishlists` (
...
CREATE TABLE IF NOT EXISTS `#__requests_reviews` (
