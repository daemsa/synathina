...
abstract class FOFView extends FOFUtilsObject
{
	 ...
	 *
	 * This function searches for Core version override templates. For example,
	 * if you have run this under Core 3.0 and you try to load
	...
	{
		// Automatically check for a Core version specific override
	 ...
	 * Core version overrides. A little slice of awesome pie!
	 *
	...
	public function loadHelper($hlp = null)
	{
		...
		// Load the template script using the default Core features
        $filesystem = FOFPlatform::getInstance()->getIntegrationObject('filesystem');
