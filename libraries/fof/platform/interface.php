 ...
 * depends on the platform FOF is running under, e.g. the Core CMS front-end,
 * the Core CMS back-end, a CLI Core Platform app, a bespoke Core
...
interface FOFPlatformInterface
{
	...
	/**
	 * Returns the human readable platform name, e.g. "Core", "Core
	 ...
	 * "component" is used in the sense of what we call "component" in Core,
	 ...
	 *
	 * @param   string  $component  The name of the component. For Core this
	 ...
	 * perform user authorisation. In some cases, like the Core back-end,
	...
	/**
	 * Perform an ACL check. Please note that FOF uses by default the Core
	...
	/**
	 * Is AJAX re-ordering supported? This is 100% Core-CMS specific. All
	 ...
	 * purged by Core. You MUST use this method to manually purge the cache.
	 *
	 * @return  boolean  True on success
	 */
	...
	/**
	 * Logs a deprecated practice. In Core this results in the $message being output in the
