...
class FOFController extends FOFUtilsObject
{
	...
	/**
	 * Sets the access to public. Core 1.5 compatibility.
	 *
	 * @return  bool
	 *
	...
	/**
	 * Sets the access to registered. Core 1.5 compatibility.
	 *
	 * @return  bool
	 *
	 * @deprecated since 2.0
	...
	/**
	 * Sets the access to special. Core 1.5 compatibility.
	 *
	 * @return  bool
	 *
	 * @deprecated since 2.0
	...
	protected function createView($name, $prefix = '', $type = '', $config = array())
	{
		 ...
		 * it be, there is no such thing as a format=utf in Core for crying out loud) which causes a Fatal Error. So
	...
	/**
	 * Applies CSRF protection by means of a standard Core token (nonce) check.
	...
	protected function _csrfProtection()
	{
		...
		// Core 1.5/1.6/1.7/2.5 (classic Core API) method
