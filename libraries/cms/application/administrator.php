...
/**
 * Core Administrator Application class
 *
 * @since  3.2
 */
class JApplicationAdministrator extends JApplicationCms
{
	...
	public function dispatch($component = null)
	{
		...
		$document->setGenerator('Core - Open Source Content Management');
	...
	protected function doExecute()
	{
		...
		if (get_magic_quotes_gpc())
		{
			...
			{
				$this->enqueueMessage('Your host needs to disable magic_quotes_gpc to run this version of Core', 'error');
			}
		}
