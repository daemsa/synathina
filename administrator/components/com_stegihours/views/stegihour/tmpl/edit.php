...
<form action="<?php echo JRoute::_('index.php?option=com_stegihours&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="stegihour-form" class="form-validate">
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="row-fluid form-horizontal-desktop">
					<div class="span6">
						<?php echo $this->form->renderField('team_id'); ?>												<?php echo $this->form->renderField('alias'); ?>
