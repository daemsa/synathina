...
<form action="<?php echo JRoute::_('index.php?option=com_stegihours&layout=modal&tmpl=component&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="stegihour-form" class="form-validate">
