...
<form action="<?php echo JRoute::_('index.php?option=com_stegihours'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="stegihourList">
				<thead>
					<tr>
						...
						<th width="31%" class="hidden-phone">
							Description
						</th>
				...
				foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
						...
						<td class="center">
							<div class="btn-group">
								<?php echo JHtml::_('jgrid.published', $item->published, $i, 'stegihours.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
								<?php
								// Create dropdown items
								//$action = $archived ? 'unarchive' : 'archive';
								//JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'stegihours');
						...
						<td class="nowrap has-context">
							<div class="pull-left" style="color:<?=($item->date_end>=date('Y-m-d H:i:s')?'blue; font-weight:bold':'black')?>">
								<?php echo JHTML::_('date', $item->date_start, 'd/m/Y H:i'); ?>
							</div>
						</td>
						<td class="nowrap has-context" style="color:<?=($item->date_end>=date('Y-m-d H:i:s')?'blue; font-weight:bold':'black')?>">
							<div class="pull-left">
								<?php echo JHTML::_('date', $item->date_end, 'd/m/Y H:i'); ?>
							</div>
						</td>						
