...
?>
<form action="<?php echo JRoute::_('index.php?option=com_stegihours&view=stegihour&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
