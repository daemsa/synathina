...
class StegihoursViewStegihours extends JViewLegacy
{
	...
	{
		$canDo	= JHelperContent::getActions('com_stegihours', 'stegihour', $this->state->get('filter.stegihour_id'));
		$user	= JFactory::getUser();

		// Get the toolbar object instance
		$bar = JToolBar::getInstance('toolbar');

		JToolbarHelper::title('Stegi Calendar');
		...
		JHtmlSidebar::setAction('index.php?option=com_stegihours');
