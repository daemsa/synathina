...
<div class="pull-right">
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('action.apply');"><?php echo JText::_('JTOOLBAR_APPLY') ?></button>
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('action.save');"><?php echo JText::_('JTOOLBAR_SAVE') ?></button>
...
<form action="<?php echo JRoute::_('index.php?option=com_actions&layout=modal&tmpl=component&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="action-form" class="form-validate">
