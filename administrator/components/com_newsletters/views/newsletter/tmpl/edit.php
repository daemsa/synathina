...
<form action="<?php echo JRoute::_('index.php?option=com_newsletters&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="newsletter-form" class="form-validate">
