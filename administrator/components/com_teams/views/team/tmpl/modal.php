...
<form action="<?php echo JRoute::_('index.php?option=com_teams&layout=modal&tmpl=component&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="team-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? 'New team' : 'Edit team'); ?>
		<div class="row-fluid">
			<div class="span9">
