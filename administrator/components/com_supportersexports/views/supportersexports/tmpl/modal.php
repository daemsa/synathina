...
$function  = $input->getCmd('function', 'jSelectSupportersexport');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_supportersexports&view=supportersexport&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<table class="table table-striped table-condensed">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php echo $this->escape($item->painter); ?>
				</td>
				<td class="center">
