...
JFactory::getDocument()->addScriptDeclaration('
	Joomla.submitbutton = function(task)
	{
		if (task == "stegihour.cancel" || document.formvalidator.isValid(document.getElementById("stegihour-form")))
		{
			...
			if (window.opener && (task == "stegihour.save" || task == "stegihour.cancel"))
			{
...
<div class="pull-right">
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('stegihour.apply');"><?php echo JText::_('JTOOLBAR_APPLY') ?></button>
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('stegihour.save');"><?php echo JText::_('JTOOLBAR_SAVE') ?></button>
	<button class="btn" type="button" onclick="Joomla.submitbutton('stegihour.cancel');"><?php echo JText::_('JCANCEL') ?></button>
</div>

<div class="clearfix"> </div>
<hr class="hr-condensed" />

<form stegihour="<?php echo JRoute::_('index.php?option=com_stegihours&layout=modal&tmpl=component&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="stegihour-form" class="form-validate">
